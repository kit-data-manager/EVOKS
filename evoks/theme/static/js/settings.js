...
document.getElementById("delete-vocabulary-button").addEventListener("click", function(e) {
    document.getElementById("delete-vocabulary-modal").classList.toggle("invisible");
});